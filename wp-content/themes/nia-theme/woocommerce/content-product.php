	...
	<a href="<?php the_permalink(); ?>">
		<div class="product-image-container relative aspect-[4/5] bg-warm-grey overflow-hidden mb-6">
			...
			<?php if ( $nia_badge_text ) : ?>
				<div class="absolute top-4 left-4 bg-tertiary-container/90 px-3 py-1 rounded-full">
					<span class="font-label-md text-label-md text-on-tertiary-container"><?php echo esc_html( $nia_badge_text ); ?></span>
				</div>
			<?php endif; ?>
			<div class="quick-add-overlay absolute inset-0 bg-black/5 flex items-end p-6 opacity-0 translate-y-4 transition-all duration-300">
