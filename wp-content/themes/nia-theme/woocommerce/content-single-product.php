...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
	...
	<?php if ( post_type_supports( 'product', 'comments' ) && comments_open( $product->get_id() ) ) : ?>
		<!-- Reviews & Ratings -->
		<section id="nia-reviews" class="mt-section-gap px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto" data-product-id="<?php echo (int) $product->get_id(); ?>">
			<h2 class="font-display-lg text-headline-lg mb-12"><?php esc_html_e( 'Customer Reviews', 'nia-theme' ); ?></h2>

			<div id="nia-reviews-grid">
				<?php Nia_Reviews::render_reviews_grid( $product ); ?>
			</div>
		</section>
	<?php endif; ?>
